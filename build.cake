...
var solutionPath = File("./src/Cake.Apigee.sln");

var zipPackage = buildResultDir + "/Cake-Apigee-v" + semVersion + ".zip";
    ...
    .Does(() =>
{
    CreateAssemblyInfo("./src/SolutionInfo.cs", new AssemblyInfoSettings
    {
        ...
        Copyright = "Copyright (c) Cybercohesion 2017"
    });
});
...
Task("Copy-Files")
    ...
    .Does(() =>
{
    CopyFileToDirectory(buildDir + "/Cake.Apigee.dll", binDir);
    CopyFileToDirectory(buildDir + "/Cake.Apigee.xml", binDir);
    ...
    .Does(() =>
{
    ...
    NuGetPush(nugetRoot + "/Cake.Apigee." + version + ".nupkg", new NuGetPushSettings
    {
        ApiKey = apiKey,
